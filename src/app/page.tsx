...
/**
 * Render the Home page containing the generative learning guide UI, including the search input, generated course content, module navigation, and auxiliary tools.
 *
 * Renders a top progress bar, star field, hero header, search area, generated course results (modules, objectives, glossary, final summary), a sidebar with study tips and export/rating actions, and footer. Automatically scrolls results into view when generation completes. When all quiz questions are completed, triggers a confetti animation and, after a short delay, shows a completion modal. Exposes a rating modal and PDF export for generated course data.
 *
 * @returns The React element for the Home page UI.
 */
